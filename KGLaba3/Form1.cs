...
namespace KGLaba3
{
    public partial class Form1 : Form
    {
        ...
        private void PictureBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            Console.WriteLine("А алгоритмы");
            Console.WriteLine(statsA + $"Всего веремени: {totalTimeA} ms.\n");
        }
        ...
        private void PictureBox2_Paint(object sender, PaintEventArgs e)
        {
            ...
            Console.WriteLine("B алгоритмы");
            Console.WriteLine(statsB + $"Всего веремени: {totalTimeB} ms.\n");
        }
        ...
        private void PictureBox3_Paint(object sender, PaintEventArgs e)
        {
            ...
            Console.WriteLine("Эталонные алгоритмы");
            Console.WriteLine(statsC + $"Всего веремени: {totalTimeC} ms.\n");
        }
        ...
        List<Pixel> PaintLineMain(double r1, double p1, double r2, double p2, Color color)
        {
            ...
            statsA += $"������ ({r1}; {p1}) ({r2}; {p2}) ��� ({x1}; {y1}) - ({x2}; {y2}): {stopwatch.Elapsed.TotalMilliseconds} ms.\n";
