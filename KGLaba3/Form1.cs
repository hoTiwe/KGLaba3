...
namespace KGLaba3
{
    public partial class Form1 : Form
    {
        ...
        {
            int x = offsetX * scale;
            int y = pictureBox1.Height + (offsetY) * scale -100;
        ...
        void paintY(Graphics graphics)
        {
            ...
            graphics.FillRectangle(new SolidBrush(Color.Red), x, 0, 2, pictureBox1.Height);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            displayTextBoxA.AppendText($"I = {diff1}{Environment.NewLine}m = {(double)diff1 / (pictureBox2.Width / scale * pictureBox2.Height / scale)}{Environment.NewLine}");
            int diff2 = CalculateDiff(bitmapB, bitmapC);

            label2.Text += $"I = {diff2}\nm = {(double)diff2 / (pictureBox2.Width / scale * pictureBox2.Height / scale)}\n";
            displayTextBoxA.AppendText($"I = {diff2}{Environment.NewLine}m = {(double)diff2 / (pictureBox2.Width / scale * pictureBox2.Height / scale)}{Environment.NewLine}");
