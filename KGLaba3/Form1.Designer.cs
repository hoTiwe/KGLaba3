namespace KGLaba3
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // button5
            // 
            button5.Location = new Point(1314, 466);
            button5.Margin = new Padding(3, 2, 3, 2);
            button5.Name = "button5";
            button5.Size = new Size(86, 27);
            button5.TabIndex = 21;
            button5.Text = "Сохранить А";
            button5.UseVisualStyleBackColor = true;
            button5.Click += button2_Click;
            // 
            // button6
            // 
            button6.Location = new Point(1314, 512);
            button6.Margin = new Padding(3, 2, 3, 2);
            button6.Name = "button6";
            button6.Size = new Size(86, 38);
            button6.TabIndex = 22;
            button6.Text = "Сохранить B";
            button6.UseVisualStyleBackColor = true;
            button6.Click += button3_Click;
            // 
            // button7
            // 
            button7.Location = new Point(1314, 564);
            button7.Margin = new Padding(3, 2, 3, 2);
            button7.Name = "button7";
            button7.Size = new Size(86, 49);
            button7.TabIndex = 23;
            button7.Text = "Сохранить эталон";
